...
get_filename_component(_filename "/home/corelab/adam_folder/HonorsThesisROSWorkspace/src/file_server/srv/GetBinaryFile.srv" NAME_WE)
add_custom_target(_file_server_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "file_server" "/home/corelab/adam_folder/HonorsThesisROSWorkspace/src/file_server/srv/GetBinaryFile.srv" ""
)

get_filename_component(_filename "/home/corelab/adam_folder/HonorsThesisROSWorkspace/src/file_server/srv/SaveBinaryFile.srv" NAME_WE)
add_custom_target(_file_server_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "file_server" "/home/corelab/adam_folder/HonorsThesisROSWorkspace/src/file_server/srv/SaveBinaryFile.srv" ""
)
